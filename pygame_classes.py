...
class PygameObject:
    ...
    def update_text(self, new_text):
        ...
        self.rect = pygame.Rect(self.pos_x - self.border_distance, self.pos_y - self.border_distance, self.width + self.border_distance*2, self.height + self.border_distance*2)
